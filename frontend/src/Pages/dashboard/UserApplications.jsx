...
const UserApplications = () => {
  ...
  const handleStatusChange = async (status) => {
    ...
    try {
      ...
      await dispatch(fetchFormById(id));
    } catch (err) {
  ...
  const handleViewDocuments = (applicantIndex) => {
  ...
  const handleDownloadDocuments = async (applicantIndex) => {
    ...
    const applicantName = personalDetail.full_name || `Applicant_${applicantIndex + 1}`;
    ...
    const docFields = [
      ...
      { key: "last12MonthSavingsAccountStatement", label: "Last_12_Month_Savings_Account_Statement" },
      ...
      { key: "last6Or12MonthBusinessAccountStatement", label: "Last_6_or_12_Month_Business_Account_Statement" },
      { key: "balanceSheets", label: "Balance_Sheets" },
      { key: "nocLoanCloseStatements", label: "NOC_Loan_Close_Statements" },
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="bg-blue-600 text-white px-4 py-1 rounded-md font-medium hover:bg-blue-700 transition duration-200 flex items-center gap-2"
                        >
                          <i className="fas fa-download"></i> Download Documents
                        </button>
                      </div>
                    </div>
                    ...
                    <>
                      <ul className="space-y-2 mb-4">
                        {[
                          ...
                          { key: "last12MonthSavingsAccountStatement", label: "Last 12 Month Savings Account Statement" },
                          ...
                          { key: "last6Or12MonthCurrentAccountStatement", label: "Last 6/12 Month Current Account Statement" },
                          { key: "last6Or12MonthBusinessAccountStatement", label: "Last 6/12 Month Business Account Statement" },
                          { key: "balanceSheets", label: "Balance Sheets" },
                          { key: "nocLoanCloseStatements", label: "NOC/Loan Close Statements" },
