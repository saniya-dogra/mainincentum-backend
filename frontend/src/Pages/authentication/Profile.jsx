...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (user?._id) {
      console.log("Fetching forms for user ID:", user._id);
      dispatch(fetchFormsByUserId(user._id));
    } else {
      console.log("No user ID available in UserContext");
      // Optional: Hardcode for testing
      // const hardcodedUserId = "67d695b8cc63417ceacad2e7";
      // dispatch(fetchFormsByUserId(hardcodedUserId));
    }
  }, [dispatch, user]);
