...
const personalDetailsSchema  = new mongoose.Schema({
    no_of_applicants: { type: Number, min: 1, max: 3 },
...
const salariedDetailsSchema = new mongoose.Schema({
  ...
  const selfEmployedDetailsSchema = new mongoose.Schema({
    ...
    company_type: { type: String, enum: ["Company", "Partnership Firm", "Proprietary Firm", "LLP", "Others"] },
    incorporation_date: { type: String }, // Changed to String to match frontend input
    designation_self: { type: String, enum: ["Proprietor", "Partner", "Founder", "Director", "Others"] },
